...
class FormUpdateApartmentPage extends React.Component{
    constructor(){
        super();
    ...
    submit(ev){
        ...
        Axios.post('http://localhost:8000/api/updateApartment', formData, {
            headers: {
...
export default withRouter(connect(state)(FormUpdateApartmentPage))