...
class FormKostPage extends React.Component{
    ...
    submit(ev){
        ...
        formData.append('room_left', this.state.roomLeft)
        ...
        Axios.post('http://localhost:8000/api/addRoom', formData, {
            headers: {
            ...
            if(response.data.status == "success"){
                ...
                this.setState({
                    ...
                    errorRoom_left : response.data.room_left,
    ...
    render(){
        ...
        if(this.state.pageCount == 2){
            ...
            <div>
                ...
                <br></br><br></br>
                <label htmlFor="roomLeft">Room Left</label>
                <input type="number" name="roomLeft" placeholder="Input Room Left" onChange={this.dataChange.bind(this)} required></input>
                {this.state.errorRoom_left}
