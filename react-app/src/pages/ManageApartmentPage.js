...
class ManageApartmentPage extends React.Component{
    constructor(){
        super();
    ...
    buttonClicked(ev){
        ...
        if(ev.target.value == 'add'){
            this.props.history.replace('/formApartment');
        }
        else{
            this.setState({
                ...
                <Container>
                   ...
                   <BreadCrumbs></BreadCrumbs>
                    <Tab>
                        ...
                        <button style={divStyle} value="delete" onClick={this.buttonClicked.bind(this)}>Delete Apartment</button>
                    </Tab>
